        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2 bg-gray-50/50 p-1.5 rounded-2xl border border-gray-100">
            <button
              ...
              className={`py-2 px-1 rounded-xl text-[9px] font-black uppercase transition-all ${pacientesFilters.estado === ''
            ...
            {[
              ...
              <button
                ...
                className={`py-2 px-1 rounded-xl text-[9px] font-black uppercase transition-all ${pacientesFilters.estado === status.id
          ...
          {data?.data?.map((paciente) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className={`w-11 h-11 rounded-xl flex-shrink-0 flex items-center justify-center transition-colors ${paciente.estado === 'ACTIVO' ? 'bg-blue-50 text-blue-600 group-hover:bg-blue-600 group-hover:text-white' : 'bg-gray-100 text-gray-400'
                  }`}>
                  <User size={20} />
                </div>
                <div className="flex-1 overflow-hidden">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <span className={`text-[9px] font-black px-2 py-0.5 rounded-md uppercase ${paciente.estado === 'ACTIVO'
